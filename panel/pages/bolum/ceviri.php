...
<div style="box-sizing:border-box;padding:15px;" id="bolum-panel">
	...
	<textarea placeholder="Buradan Bölümün Temizleyicisine, Dizgicisine ve Kontrolcünüze Not Bırakabilirsiniz." class="placeanote"></textarea>

	<div class="bolum-sayfasi_bot">
		<div id="ceviri-gonder" class="bolum-gonder">
			Bölümü Gönder
		</div>		
	</div>
